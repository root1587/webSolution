...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .authorizeHttpRequests()
                .requestMatchers("/admin/projects").permitAll()
                
                // 토큰이 없는 상태에서 요청이 들어오는 API들은 permitAll
                .and()
                .authorizeHttpRequests()
                .requestMatchers("/admin/clients").permitAll()
                
                // 토큰이 없는 상태에서 요청이 들어오는 API들은 permitAll
                .and()
                .authorizeHttpRequests()
                .requestMatchers("/admin/clientProjects").permitAll()
                
                // 토큰이 없는 상태에서 요청이 들어오는 API들은 permitAll
                .and()
                .authorizeHttpRequests()
                .requestMatchers("/admin/login").permitAll()//.hasRole("ADMIN")
